...
$html = str_replace('<!--{recursoJs}-->', Includer::addJs('jquery-1.6.1.min', 'listarRecibiOfertas', 'selectCategoriasRecibiOfertas', 'selectProvinciasRecibiOfertas', 'loginRegister', 'cufon-yui', 'HelvLight_400.font', 'dropdown-menu', 'jquery.colorbox', 'loginRegister', 'galleryBox', 'compartir', 'validadores', 'newsletter', 'seguir'), $html);
...
<body>
    ...
    <div id="content-wrapper">
        <?php
            include_once('tpl/contenidoRecibiOfertas.php');
        ?>
        </div>
        <!-- FIN CONTENT WRAPPER -->
