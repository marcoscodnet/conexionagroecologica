...
$html = str_replace('<!--{recursoJs}-->', Includer::addJs('jquery-1.6.1.min', 'casoExitoso', 'cufon-yui', 'HelvLight_400.font', 'dropdown-menu', 'jquery-ui.min', 'jquery.colorbox', 'loginRegister', 'mensaje', 'comprar', 'galleryBox', 'compartir', 'seguir', 'borrar', 'validadores', 'newsletter'), $html);
...
<body>
    ...
    <div id="content-wrapper">
        <?php
            include_once('php/printers/casoExitoso.printer.php');
        ?>
    </div>
    <!-- FIN CONTENT WRAPPER -->
