...
$html = str_replace('<!--{recursoJs}-->', Includer::addJs('jquery-1.6.1.min', 'jquery.colorbox', 'loginRegister', 'cufon-yui', 'HelvLight_400.font', 'dropdown-menu', 'jquery-ui.min', 'listarMensajesEnviadosAdmin', 'validadores', 'newsletter', 'seguir'), $html);
...
<body>
    ...
    <div id="content-wrapper">
        <?php include 'tpl/contenidoMensajesEnviadosAdmin.php'; ?>
    </div>
    <!-- FIN CONTENT WRAPPER -->
