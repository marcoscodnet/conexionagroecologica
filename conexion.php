...
$html = str_replace('<!--{recursoJs}-->', Includer::addJs('jquery-1.6.1.min',  'cufon-yui', 'HelvLight_400.font', 'dropdown-menu', 'jquery-ui.min', 'jquery.colorbox', 'loginRegister', 'mensaje', 'comprar', 'galleryBox', 'galleryBox2', 'compartir', 'seguir', 'borrarConexion', 'validadores', 'newsletter'), $html);
$html = str_replace('<!--{recursoCss}-->', Includer::addCss('reset', 'vistas', 'jquery-ui', 'jquery.fileupload-ui', 'colorbox', 'galleryBox'), $html);
...
<body>
    ...
    <div id="content-wrapper">
    	<?php include('php/controllers/mostrarTransaccion.controller.php'); ?>
    </div>
    <!-- FIN CONTENT WRAPPER -->
