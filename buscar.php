...
$posibles = Doctrine::getTable('posibleUsoSuelo')->find(1);
$html = Archivo::leer('tpl/header.html');
$html = str_replace('<!--{recursoJs}-->', Includer::addJs('jquery-1.6.1.min', 'listarPropiedades', 'selectCategorias', 'selectProvincias', 'loginRegister', 'cufon-yui', 'HelvLight_400.font', 'dropdown-menu', 'jquery.colorbox', 'loginRegister', 'galleryBox', 'compartir', 'validadores', 'newsletter', 'seguir'), $html);
...
<body>
    ...
    <div id="content-wrapper">
        <?php
            include_once('tpl/contenidoBuscar.php');
        ?>
        </div>
        <!-- FIN CONTENT WRAPPER -->
