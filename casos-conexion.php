...
$html = str_replace('<!--{recursoJs}-->', Includer::addJs('jquery-1.6.1.min', 'jquery.colorbox', 'loginRegister',  'dropdown-menu', 'cufon-yui', 'HelvLight_400.font', 'jquery.carouFredSel-4.2.3-packed', 'casosConexion', 'validadores', 'newsletter'), $html);
...
<body>
    ...
    <?php include_once('tpl/contenidoCasosConexion.php'); ?>
    </div>
    <!-- FIN CONTENT WRAPPER -->
