...
function hacerPeticion (pagina) {
    ...
    $.ajax({
        type:'POST',
        url:'php/controllers/listarPublicacionesAdmin.controller.php',
        data:formData,
        beforeSend:function () {
            ...
            onComplete:function () {
                $.ajax({
                    ...
                    success:function (ok) {
                        ...
                        if (ok == 'error') {
                            $.colorbox({
                                href:'tpl/mensajes/aceptarPublicacion.error.php', 
                                iframe:true, 
                                innerWidth:400, 
                                innerHeight:300
                            })
                            ...
                            $.colorbox({
                                href:'tpl/mensajes/aceptarPublicacion.exito.php', 
                                iframe:true, 
                                innerWidth:400, 
                                innerHeight:300
                            })
