...
$html = str_replace('<!--{recursoJs}-->', Includer::addJs('jquery-1.6.1.min', 'jquery.colorbox', 'loginRegister', 'cufon-yui', 'HelvLight_400.font', 'dropdown-menu', 'jquery-ui.min', 'listarMiConexion', 'validadores', 'newsletter', 'cambiarPass', 'cambiarDatos'), $html);
$html = str_replace('<!--{recursoCss}-->', Includer::addCss('reset', 'vistas', 'jquery-ui', 'jquery.fileupload-ui', 'colorbox', 'formularios'), $html);
...
<body>
    ...
    <div id="content-wrapper">
        <?php include 'tpl/contenidoDatosPersonales.php'; ?>
    </div>
    <!-- FIN CONTENT WRAPPER -->
