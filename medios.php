...
$html = str_replace('<!--{recursoJs}-->', Includer::addJs('jquery-1.6.1.min', 'jquery.colorbox', 'loginRegister',  'dropdown-menu', 'cufon-yui', 'HelvLight_400.font', 'medios', 'validadores', 'newsletter'), $html);
...
<body>
    ...
    <?php include_once('tpl/contenidoMedios.php'); ?>
    </div>
    <!-- FIN CONTENT WRAPPER -->
