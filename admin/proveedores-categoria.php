<?php 
    ...
    if (isset($_GET['id'])) {
        $CATEGORIA = Doctrine::getTable('CategoriaProveedor')->find($_GET['id'])->value;
    } else {
        $CATEGORIA = '';
    }
?>
...
<body class="">
    ...
    <div id="main" role="main">
        <?php include('tpl/proveedores-categoria.tpl'); ?>
    </div>
    <!-- /MAIN PANEL -->
    ...
    <script src="js/proveedoresCategoria.js"></script>
