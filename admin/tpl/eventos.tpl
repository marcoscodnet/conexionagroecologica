...
<div id="content">
    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-5 col-md-5 col-lg-8 text-right">
            <a href="evento" class="btn btn-success"><span class="fa fa-plus"></span> Cargar evento</a>
        </div>
        <!-- /col -->
                ...
                >
                    ...
                    <div role="content">
                        ...
                        <div class="widget-body no-padding">
                            ...
                            <p>&nbsp;</p>
                            <p class="text-right"><a href="evento" class="btn btn-success"><span class="fa fa-plus"></span> Cargar evento</a>&nbsp;&nbsp;</p>
                        </div>
                        <!-- /widget content -->
