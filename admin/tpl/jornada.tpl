...
<div id="ribbon">
    ...
    <!-- breadcrumb -->
    <ol class="breadcrumb">
        <li>Jornadas Técnicas</li><li>${accion}</li>
    </ol>
    <!-- /breadcrumb -->
                ...
                >
                    ...
                    <div>
                        ...
                        <div class="widget-body">
                            ...
                            <form action="php/controllers/jornada.controller.php" method="post">
                                ...
                                <fieldset class="smart-form">
                                    ...
                                    <div class="row">
                                        ...
                                        <section class="col col-md-4 col-sm-4 col-xs-12">
                                            ...
                                            <label class="input">
                                                <input autofocus="autofocus" type="text" name="blog" value="${blog}" />
                                            </label>
                                        </section>
                            ...
                            <div class="row hidden-mobile">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-align-right">
                                    <div class="page-title">
                                        <form id="imagesUploader" action="php/uploaders/jornadaImagen.uploader.php" method="post" enctype="multipart/form-data">
