                ...
                >
                    ...
                    <div>
                        ...
                        <div class="widget-body">
                            ...
                            <form action="php/controllers/popup.controller.php" method="post">
                                    ...
                                    <div class="row">
                                        ...
                                        <section class="col col-md-4 col-sm-4 col-xs-12">
                                            <label class="label">Blog</label>
                                          	<label class="input">
                                                <input autofocus="autofocus" type="text" name="ruta" value="${ruta}" />
                                            </label>
                                        </section>
                                            
                                        <section class="col col-md-2 col-sm-3 col-xs-12">
                                            <label class="label margin-top-5">Activo</label>
                                            <label class="select">
                                                <span class="onoffswitch">
                                                    <input type="checkbox" name="activo" class="onoffswitch-checkbox" id="activo" ${checked}>
                            ...
                            <div class="row hidden-mobile">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-align-right">
                                    <div class="page-title">
                                        <form id="imagesUploader" action="php/uploaders/popupImagen.uploader.php" method="post" enctype="multipart/form-data">
