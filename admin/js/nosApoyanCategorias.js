...
$(document).ready(function () {
    ...
    $('#left-panel li[data-nav="sponsors-categorias"]').addClass('active');
})
...
function dtInit () {
    dataTable = $('#categorias').DataTable({
        ...
        serverSide: true,
        stateSave: false,
        ajax: BASE_URL+'php/providers/nosApoyanCategorias.provider.php',
        language: dtLanguage,
        columns: [
            { 'data': 'categoria' },
            { 'data': 'acciones' }
...
function cargar () {
    ...
    $('.agregarCategoria').unbind('click').click(function (event) {
        ...
        $('#modalAction').unbind('click').click(function () {
            ...
            $.ajax({
                type: 'POST',
                url: BASE_URL+'php/controllers/categoriaNosApoyan.controller.php',
                data: data,
                beforeSend: function () {
                    loaderModalInit();
                },
...
function editar () {
    var data;
    $('.editarCategoria').unbind('click').click(function (event) {
        event.preventDefault();
        editarModalInit($(this).attr('data-value'), $(this).attr('data-id'));
        $('#myModal').modal('show');
...
function borrar () {
    ...
    $('.borrarCategoria').click(function (event) {
        ...
        $('#myModal #modalAction').click(function () {
            ...
            $.ajax({
                type:'post',
                url: BASE_URL+'php/controllers/borrarCategoriaNosApoyan.controller.php',
                data:{id:id},
...
function editarModalInit (v, i) {
    var value = v || '';
    var id = i || '';
    $('#myModal #myModalLabel .text').html('Categoría');
    $('#myModal #myModalLabel .jarviswidget-loader').hide();
    $('#myModal .modal-body').html('<form class="smart-form"><label class="input"><input type="text" name="value" value="'+value+'" autofocus="autofocus" /></label><input type="hidden" name="id" value="'+id+'"></form>');
