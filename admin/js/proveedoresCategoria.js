...
function dtInit () {
    dataTable = $('#subcategorias').DataTable({
        ...
        stateSave: false,
        ajax: {
            url: BASE_URL+'php/providers/proveedoresSubcategorias.provider.php',
            data: function ( d ) {
...
function cargar () {
    ...
    $('.agregarSubategoria').unbind('click').click(function (event) {
        ...
        $('#modalAction').unbind('click').click(function () {
            ...
            $.ajax({
                type: 'POST',
                url: BASE_URL+'php/controllers/subcategoriaProveedor.controller.php',
...
function borrar () {
    ...
    $('.borrarSubcategoria').click(function (event) {
        ...
        $('#myModal #modalAction').click(function () {
            ...
            $.ajax({
                type:'post',
                url: BASE_URL+'php/controllers/borrarSubcategoriaProveedor.controller.php',
                data:{id:id},
                success: function (response) {
                    $('#myModal').modal('hide');
