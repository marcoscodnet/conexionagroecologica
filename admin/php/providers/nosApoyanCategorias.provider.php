...
$data = Doctrine_Query::create()
        ->select('
            ...
            CONCAT("
                ...
                <a href=\"#\" data-id=\"",c.id,"\"  data-value=\"",c.value,"\" class=\"btn btn-primary editarCategoria\"><i class=\"fa fa-pencil\"></i></a>
            "
            ) as acciones,
...
if ($_GET['search']['value']) {
    $data->andWhere('c.value like ?', array($_GET['search']['value'].'%'));
    $recordsFiltered->andWhere('c.value like ?', array($_GET['search']['value'].'%'));
}
//fin busqueda
