...
if (!class_exists('Paginador')) include(RUTA_LOCAL.'php/clases/Paginador.php');
$cuantos = 13;
$pagina = (isset($_POST['pagina']))?$_POST['pagina']:1;
$desde = ($pagina-1)*$cuantos;

$q = Doctrine_Query::create()
        ->select('p.id, p.nombre, p.tel, p.email, p.web, p.descripcion, cat.value as categoria, sub.value as subcategoria, prov.contenido as provincia, l.contenido as localidad')
        ->from('Proveedor p')
...
$q2 = $q->copy();
$total = $q->removeDqlQueryPart('select')
