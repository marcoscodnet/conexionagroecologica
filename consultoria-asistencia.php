...
$html = str_replace('<!--{recursoJs}-->', Includer::addJs('jquery-1.6.1.min', 'WinModal', 'loginRegister', 'cufon-yui', 'HelvLight_400.font', 'dropdown-menu', 'jquery.colorbox', 'loginRegister', 'validadores', 'newsletter'), $html);
$html = str_replace('<!--{recursoCss}-->', Includer::addCss('reset', 'winModal', 'vistas', 'colorbox'), $html);
...
<body>
    ...
    <div id="content-wrapper">
    	<?php include_once('tpl/contenidoConsultoriaAsistencia.html'); ?>
    </div>
    <!-- FIN CONTENT WRAPPER -->
