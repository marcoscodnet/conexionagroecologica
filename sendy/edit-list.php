...
<script src="<?php echo get_app_info('path');?>/js/redactor/redactor.min.js?6"></script>
<script src="<?php echo get_app_info('path');?>/js/redactor/fontcolor.js?6"></script>
<script src="<?php echo get_app_info('path');?>/js/redactor/fontsize.js?6"></script>
<script src="<?php echo get_app_info('path');?>/js/redactor/fontfamily.js?6"></script>
<link rel="stylesheet" href="<?php echo get_app_info('path');?>/js/redactor/redactor.css?6" />
<script src="<?php echo get_app_info('path');?>/js/lists/editor.js?6"></script>
	    	...
	    	<div class="span4">
		        ...
		        <div class="well">
			        ...
			        <div class="well" style="background: #FFFDEC;">
			        	...
			        	<p><?php echo _('Example');?>:<br/><span class="label label-info">http://domain.com/subscribed.php?email=%e&listid=%l</span></p>
		        ...
		        <div class="well">
			        ...
			        <div class="well" style="background: #FFFDEC;">
			        	...
			        	<p><?php echo _('Example');?>:<br/><span class="label label-info">http://domain.com/confirmed.php?email=%e&listid=%l</span></p>
			        	<p><?php echo _('<code>%e</code> will be converted into the \'email\' and <code>%l</code> will be converted into the \'listID\' that unsubscribed');?>.</p>
		        	</div>
		        </div>
	    	</div>
	    	...
	    	<div class="span4">
		        ...
		        <div class="well">
			        ...
			        <div class="well" style="background: #FFFDEC;">
			        	...
			        	<p><?php echo _('Example');?>:<br/><span class="label label-info">http://domain.com/unsubscribed.php?email=%e&listid=%l</span></p>
			        	<p><?php echo _('<code>%e</code> will be converted into the \'email\' and <code>%l</code> will be converted into the \'listID\' that unsubscribed');?>.</p>
		        	</div>
		        </div>
	    	</div>
