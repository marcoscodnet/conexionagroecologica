...
$html = str_replace('<!--{recursoJs}-->', Includer::addJs('jquery-1.6.1.min', 'jquery.colorbox', 'loginRegister', 'cufon-yui', 'HelvLight_400.font', 'dropdown-menu', 'jquery-ui.min', 'listarUsuariosAdmin', 'validadores', 'newsletter'), $html);
...
<body>
    ...
    <div id="content-wrapper">
        <?php include 'tpl/contenidoListadoUsuariosAdmin.php'; ?>
    </div>
    <!-- FIN CONTENT WRAPPER -->
