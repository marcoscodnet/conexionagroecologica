...
$html = str_replace('<!--{recursoJs}-->', Includer::addJs('jquery-1.6.1.min',  'cufon-yui', 'HelvLight_400.font', 'dropdown-menu', 'jquery-ui.min', 'jquery.colorbox', 'loginRegister', 'mensaje', 'comprar', 'galleryBox', 'galleryBox2', 'compartir', 'seguir', 'borrar', 'validadores', 'newsletter'), $html);
...
<body>
    ...
    <div id="content-wrapper">
    	<?php 
		include_once('php/controllers/mostrarPropiedad.controller.php');
		?>
    </div>
    <!-- FIN CONTENT WRAPPER -->
