...
<html>
    ...
    <body>
        <div class="formTemplate formAceptarTransaccionError">
            <div class="formEncabezado">
                <p><span class="iconsSprite iconError">ERROR</span></p>
            </div>
            <div class="camposContainer">
                <p><b>La conexi&oacute;n no se pudo dar de alta</b></p>
                <p>Ha ocurrido un error mientras se daba de alta la conexi&oacute;n.</p>
            </div>
            <div class="clear"></div>
        </div>
