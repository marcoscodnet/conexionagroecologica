...
<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            setTimeout(window.parent.cerrarColorbox, 2200);
        </script>
    </head>

    <body>
        <div class="formTemplate formAceptarPublicacionExito">
            <div class="formEncabezado">
                <p><span class="iconsSprite iconAtencion">Atenci&oacute;n</span></p>
            </div>
            <div class="camposContainer">
                <p><b>La publicaci&oacute;n ha sido dada de alta</b></p>
                <p>La publicaci&oacute;n se dio de alta con &eacute;xito.</p>
            </div>
            <div class="clear"></div>
        </div>
