<div id="contenedorBloqueSolapa">
    <div class="contMenuIzqBack">
        <div class="cajaIzqMenuBack">
            ...
            <div class="cajaBotonesBack">
                <ul id="botoneraRightBack">
                    ...
                    <li><a href="listado-usuarios-admin.php">Usuarios</a></li>
        ...
        <div class="cajaIzqMenuBack">
            ...
            <div class="cajaBotonesBack">
                <ul id="botoneraRightBack">
                    <li><a href="mensajes-enviados-admin.php" id="listarMensajesEnviados">Enviados</a></li>
                    <li class="roundBottom"><a href="mensajes-recibidos-admin.php" class="activo" id="listarMensajesRecibidos">Recibidos</a></li>
                </ul>
                <div class="clear"></div>
            </div>
        </div>
